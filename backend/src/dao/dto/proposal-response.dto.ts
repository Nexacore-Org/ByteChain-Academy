...
export class ProposalResponseDto {
  ...
  description: string;
  @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174000', description: 'proposerId field' })
  proposerId: string;
  @ApiProperty({ example: 'example', description: 'status field' })
  status: ProposalStatus;
  @ApiProperty({ example: '2026-04-22T00:00:00.000Z', description: 'votingDeadline field' })
  votingDeadline: Date;
...
export class PaginatedProposalsDto {
  @ApiProperty({ example: [{ id: '123e4567-e89b-12d3-a456-426614174000', title: 'Example Proposal', description: 'A concise description of the resource.', proposerId: '123e4567-e89b-12d3-a456-426614174000', status: 'pending', votingDeadline: '2026-04-22T00:00:00.000Z', yesVotes: 1, noVotes: 0, abstainVotes: 0, createdAt: '2026-04-22T00:00:00.000Z' }], description: 'proposals field' })
