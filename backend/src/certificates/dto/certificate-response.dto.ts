...
export class CertificateResponseDto {
  ...
  @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174000', description: 'isValid field' })
  @IsBoolean()
  isValid: boolean;
...
export class CertificateVerificationResultDto {
  ...
  @ApiProperty({ example: 'example', description: 'certificate field', required: false })
  @IsOptional()
  @ValidateNested()
