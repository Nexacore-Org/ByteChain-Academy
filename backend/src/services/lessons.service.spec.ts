...
describe('LessonsService', () => {
  ...
  describe('findAllByCourse', () => {
    ...
    it('should throw NotFoundException if course does not exist', async () => {
      ...
      await expect(service.findAllByCourse(courseId)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException if lesson does not exist', async () => {
      ...
      await expect(service.findOne(lessonId)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException if lesson does not exist', async () => {
      ...
      await expect(service.update(lessonId, updateDto)).rejects.toThrow(NotFoundException);
    });
