...
export class QuizSubmissionResponseDto {
  ...
  userId: string;
  @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174000', description: 'quizId field' })
  quizId: string;
  ...
  passed: boolean;
  @ApiProperty({ example: '2026-04-22T00:00:00.000Z', description: 'submittedAt field' })
  submittedAt: Date;
...
export class QuestionResponseDto {
  ...
  type: QuestionType;
  @ApiProperty({ example: ['Option 1', 'Option 2'], description: 'options field' })
  options: string[];
}
...
export class QuizResponseDto {
  ...
  lessonId: string;
  @ApiProperty({ example: [{ id: '123e4567-e89b-12d3-a456-426614174000', text: 'What is blockchain?', type: 'multiple-choice', options: ['Option 1', 'Option 2'] }], description: 'questions field' })
...
export class AdminQuizResponseDto extends QuizResponseDto {
  @ApiProperty({ example: [{ id: '123e4567-e89b-12d3-a456-426614174000', text: 'What is blockchain?', type: 'multiple-choice', options: ['Option 1', 'Option 2'], correctAnswer: 'Option 1' }], description: 'questions field' })
